...
@asset(
    ...
    description="Get the list of genomes and there orientation into a dictionnary",
    compute_kind="Python",
    metadata={"owner": "Virginie Grosboillot"},
)
def create_genome_dict(context, config: Genome):

    return config.genome_dict
...
def create_graph(context, extract_locus_tag_gene, parse_blastn, create_genome_dict, config: Diagram):
...
#         )
#         return gd_diagram.write(f"{folder}/{name}.svg", "SVG") 