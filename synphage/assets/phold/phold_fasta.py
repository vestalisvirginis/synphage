...
@asset(
    ...
    description="Create a fasta file of amino acid sequences for each dataset (phold workflow)",
    compute_kind="Python",
    io_manager_key="io_manager",
    metadata={"owner": OWNER},
)
def phold_create_fasta_p(context, append_processed_df) -> FastaPRecord:
    # Path to fasta folder
    _fasta_path = context.resources.local_resource.get_paths()["PHOLD_FASTA_P_DIR"]
    ...
    _path_history = Path(fs) / "phold_create_fasta_p"
